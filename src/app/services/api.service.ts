...
export class ApiServices {
    ...
    public apiCall(endpoint: any, method: any, data: any) {
        ...
        switch (method) {
            ...
            case "PUT":
                return this.http.put(this.URL_API + endpoint, data, httpOptions);
            case "DELETE":
                return this.http.delete(this.URL_API + endpoint, { headers: headers, params: data, withCredentials: true });
            default:
